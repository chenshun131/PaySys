package com.chenshun.pay.common.utils.rsa;

import com.chenshun.pay.common.config.PublicConfig;
...
/**
 * User: mew <p />
 * Time: 18/4/12 14:23  <p />
 * Version: V1.0  <p />
 * Description: AES加解密
 * (加密/解密算法：AES，工作模式：ECB，填充方式：NoPadding，其中若加密字符串长度不是16的倍数，则在其后补足0x00) <p />
 */
