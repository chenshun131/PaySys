 ...
 * Version: V1.0  <p />
 * Description: 封装了HttpClient 往服务器发送请求的接口
 * 让用户不适用任何HttpClient 的api 的直接调用该接口就可以实现相应的操作 <p />
 */
public interface HttpClientWrapper {
     ...
     * @throws IOException
     */
    void doRequest(HttpResponseCallBack callback, MethodType method, String url, Map<String, String> params, String charset)
